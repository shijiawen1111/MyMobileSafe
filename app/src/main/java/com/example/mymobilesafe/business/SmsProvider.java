...
import com.example.mymobilesafe.bean.SmsBean;
...
/**
 * 短信还原和短信备份业务逻辑类的实现
 * Created by JW.S on 2020/9/6 7:52 PM.
 */
public class SmsProvider {
     ...
     * @param listener
     */
    public static void smsRetore(final Context context, final OnSmsListener listener) {
        ...
        new AsyncTask<Void, Integer, Boolean>() {
            ...
            protected Boolean doInBackground(Void... voids) {
                List<SmsBean> list = new ArrayList<>();
                // 读取短信文件
                File file = new File(Environment.getExternalStorageState(), "sms.json");
    ...
    public interface OnSmsListener {
        ...
        void onFinish(boolean result);//结束阶段
    }
}
